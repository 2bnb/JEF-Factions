/* ----------------------------------------------------------------------------
Function: bnb_fa_arsenals_fnc_arsenal
...
Examples:
	["WEST", [car_1,car_2]] call bnb_f_core_fnc_arsenal;

	["WEST", player] call bnb_f_core_fnc_arsenal;

	["WEST"] call bnb_f_core_fnc_arsenal;

	[] call bnb_f_core_fnc_arsenal;
...
private _whitelist = [_filter] call bnb_fa_arsenals_fnc_getArsenalFilter;
