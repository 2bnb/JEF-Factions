...
#define BNB_FA_Magazines_Ammo MAG_XX(CUP_120Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M,12)\
MAG_XX(CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M,12)\
MAG_XX(CUP_200Rnd_TE4_Red_Tracer_556x45_M249,12)\
MAG_XX(CUP_20Rnd_762x51_DMR,12)\
MAG_XX(CUP_20Rnd_762x51_B_M110,12)\
MAG_XX(CUP_20Rnd_762x51_B_SCAR_bkl,12)\
MAG_XX(CUP_20Rnd_762x51_HK417,12)\
MAG_XX(CUP_20Rnd_762x51_G3,12)\
MAG_XX(CUP_25Rnd_762x51_Galil_Mag,12)\
MAG_XX(CUP_30Rnd_9x19_UZI,6)\
MAG_XX(CUP_30Rnd_9x19_MP5,6)\
MAG_XX(CUP_40Rnd_46x30_MP7,6)\
MAG_XX(CUP_35Rnd_556x45_Galil_Mag,24)\
MAG_XX(CUP_30Rnd_556x45_Stanag,24)\
MAG_XX(CUP_30Rnd_556x45_G36,24)\
MAG_XX(CUP_17Rnd_9x19_glock17,12)\
MAG_XX(CUP_7Rnd_45ACP_1911,12)
